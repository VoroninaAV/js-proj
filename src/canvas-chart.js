function renderChart(canvas, data) {
    ...
    let hBarMax = Math.max(getMaxOfArray(series[0]), getMaxOfArray(series[1])) // значения по у, в мировых координатах
    hBarMax=Math.ceil(hBarMax) 
